...
// precisar de ajuste depois que a imagem 360 de Astrax for
// publicada em assets/astrax.png. Para calibrar: abra a página com
...
const MAP_IMAGE_URL = 'https://aden-rpg.pages.dev/assets/astrax.png'; // mesmo nome de arquivo — só troque o PNG no repositório
...
const CITY_SPOTS = [
    { id: 'btnMercador', yaw: -35, pitch: -23, width: 150, height: 250 },
    { id: 'btnOficina', yaw: -120, pitch: -34, width: 170, height: 210 },
    { id: 'btnPotionMaster', yaw: -67, pitch: -28, width: 150, height: 230 },
    { id: 'btnChancelaria', yaw: -150, pitch: -10, width: 310, height: 200 },
    { id: 'cityGuildHotspot', yaw: -55, pitch: 34, width: 140, height: 150 },
];
...
function initSkybox() {
    ...
    new THREE.TextureLoader().load(
        ...
        undefined,
        (err) => console.error('[Astrax] Falha ao carregar a imagem 360 do mapa:', err)
    );
...
// ao vivo de #guild_name_astrax/#guild_flag_astrax (já preenchidos por
// fetchAndDisplayCityOwner, em astrax.html). Se não houver guilda regente
// no momento (dataset.cityHidden === '1'), o clique não faz nada.
// ════════════════════════════════════════════════════════════════════════════

const GUILD_ID_SUFFIX = 'astrax';
...
const PM_SCENE_IMAGE_URL = 'https://aden-rpg.pages.dev/assets/mdp_astrax.png'; // mesma imagem do antigo background do modal da loja
const PM_NPC_IMAGE_URL   = 'https://aden-rpg.pages.dev/assets/mdp_seller_astrax.webp';
const PM_TUTORIAL_KEY    = 'mdpTutorialSeen_astrax'; // localStorage — tutorial não repete depois da 1ª vez
...
const PM_NPC_SPOT = {
    ...
    heightFrac: 0.52,    // fração da altura da tela que ele ocupa, calibrada no FOV de referência (PM_INITIAL_FOV)
};
