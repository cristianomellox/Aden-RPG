...
// precisar de ajuste depois que a imagem 360 de Elendor for
// publicada em assets/elendor.png. Para calibrar: abra a página com
...
const MAP_IMAGE_URL = 'https://aden-rpg.pages.dev/assets/elendor.png'; // mesmo nome de arquivo — só troque o PNG no repositório
...
const CITY_SPOTS = [
    ...
    { id: 'btnOficina', yaw: -167, pitch: -47, width: 180, height: 370 },
    { id: 'btnPotionMaster', yaw: -76, pitch: -60, width: 260, height: 320 },
...
function initSkybox() {
    ...
    new THREE.TextureLoader().load(
        ...
        undefined,
        (err) => console.error('[Elendor] Falha ao carregar a imagem 360 do mapa:', err)
    );
...
// ao vivo de #guild_name_elendor/#guild_flag_elendor (já preenchidos por
// fetchAndDisplayCityOwner, em elendor.html). Se não houver guilda regente
// no momento (dataset.cityHidden === '1'), o clique não faz nada.
// ════════════════════════════════════════════════════════════════════════════

const GUILD_ID_SUFFIX = 'elendor';
...
const PM_SCENE_IMAGE_URL = 'https://aden-rpg.pages.dev/assets/mdp_elendor.png'; // mesma imagem do antigo background do modal da loja
const PM_NPC_IMAGE_URL   = 'https://aden-rpg.pages.dev/assets/mdp_seller_elendor.webp';
const PM_TUTORIAL_KEY    = 'mdpTutorialSeen_elendor'; // localStorage — tutorial não repete depois da 1ª vez
