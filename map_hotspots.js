(function() {
    const hotspots = [
        ...
        { id: 'penumbra_uivante', name: 'Penumbra Uivante', top: 385, left: 490, width: 190, height: 110, url: '/penumbra_uivante.html', color: '#ffc3c3' },
        { id: 'razar', name: 'Razar', top: 960, left: 530, width: 130, height: 60, url: '/razar.html', color: '#ffc3c3' },
        { id: 'desfiladeiro', name: 'Desfiladeiro do Sol Poente', top: 1300, left: 560, width: 130, height: 60, url: '/desfiladeiro.html', color: '#ffc3c3' },
        { id: 'covil_de_kelts', name: 'Covil de Kelts', top: 390, left: 855, width: 130, height: 100, url: '/covil_de_kelts.html', color: '#ffc3c3' },
        { id: 'queda_fontana', name: 'Queda Fontana', top: 740, left: 1070, width: 130, height: 60, url: '/queda_fontana.html', color: '#ffc3c3' },
        { id: 'enclave_etereo', name: 'Enclave Etéreo', top: 870, left: 1280, width: 130, height: 100, url: '/enclave_etereo.html', color: '#ffc3c3' },
        { id: 'pantano', name: 'Pântano de Molinar', top: 440, left: 1240, width: 160, height: 120, url: '/pantano_de_molinar.html', color: '#ffc3c3' },
        { id: 'duratar', name: 'Duratar', top: 280, left: 1190, width: 150, height: 100, url: '/duratar.html', color: '#84e000' },
        { id: 'astrax', name: 'Astrax', top: 1250, left: 1135, width: 150, height: 100, url: '/astrax.html', color: '#84e000' },
        { id: 'tandra', name: 'Tandra', top: 1165, left: 570, width: 150, height: 100, url: '/tandra.html', color: '#84e000' },
        { id: 'mitrar', name: 'Mitrar', top: 1030, left: 490, width: 118, height: 75, url: '/mitrar.html', color: '#84e000' },
        { id: 'mina', name: 'Minas', top: 1015, left: 680, width: 148, height: 85, url: '/mines.html', color: '#b7a5ff' },
        { id: 'elendor', name: 'Elendor', top: 820, left: 350, width: 148, height: 95, url: '/elendor.html', color: '#84e000' },
        { id: 'erbaria', name: 'Erbária', top: 830, left: 540, width: 118, height: 75, url: '/erbaria.html', color: '#ffc3c3' },
    ...
    function atualizarBadgeGPS(mapImage) {
        ...
        panel.innerHTML =
            `<div class="gps-label">
                <span class="gps-line1">Você está caçando em</span>
                <span class="gps-line2">${regionName}</span>
            </div>
