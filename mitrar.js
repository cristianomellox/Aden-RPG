...
// precisar de ajuste depois que a imagem 360 de Mitrar for
// publicada em assets/mitrar.png. Para calibrar: abra a página com
...
const MAP_IMAGE_URL = 'https://aden-rpg.pages.dev/assets/mitrar.png'; // mesmo nome de arquivo — só troque o PNG no repositório
...
const CITY_SPOTS = [
    { id: 'btnMercador', yaw: -125, pitch: -50, width: 230, height: 350 },
    { id: 'btnOficina', yaw: -2, pitch: -35, width: 200, height: 320 },
    { id: 'btnPotionMaster', yaw: -44, pitch: -40, width: 200, height: 330 },
    { id: 'btnChancelaria', yaw: -138, pitch: 0, width: 290, height: 290 },
    { id: 'cityGuildHotspot', yaw: -94, pitch: 38, width: 140, height: 150 },
];
...
function initSkybox() {
    ...
    new THREE.TextureLoader().load(
        ...
        undefined,
        (err) => console.error('[Mitrar] Falha ao carregar a imagem 360 do mapa:', err)
    );
...
// ao vivo de #guild_name_mitrar/#guild_flag_mitrar (já preenchidos por
// fetchAndDisplayCityOwner, em mitrar.html). Se não houver guilda regente
// no momento (dataset.cityHidden === '1'), o clique não faz nada.
// ════════════════════════════════════════════════════════════════════════════

const GUILD_ID_SUFFIX = 'mitrar';
...
const PM_SCENE_IMAGE_URL = 'https://aden-rpg.pages.dev/assets/mdp_mitrar.png'; // mesma imagem do antigo background do modal da loja
const PM_NPC_IMAGE_URL   = 'https://aden-rpg.pages.dev/assets/mdp_seller_mitrar.webp';
const PM_TUTORIAL_KEY    = 'mdpTutorialSeen_mitrar'; // localStorage — tutorial não repete depois da 1ª vez
