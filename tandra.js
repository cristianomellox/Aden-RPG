...
const PM_SCENE_IMAGE_URL = 'https://aden-rpg.pages.dev/assets/mdp_tandra.png'; // mesma imagem do antigo background do modal da loja
const PM_NPC_IMAGE_URL   = 'https://aden-rpg.pages.dev/assets/mdp_seller_tandra.webp';
const PM_TUTORIAL_KEY    = 'mdpTutorialSeen_tandra'; // localStorage — tutorial não repete depois da 1ª vez
