...
// precisar de ajuste depois que a imagem 360 de Zion for
// publicada em assets/zion.png. Para calibrar: abra a página com
...
const CITY_SPOTS = [
    { id: 'btnMercador', yaw: -20, pitch: -10, width: 260, height: 260 },
    { id: 'btnOficina', yaw: -125, pitch: -35, width: 340, height: 360 },
    { id: 'btnPotionMaster', yaw: -73, pitch: 3, width: 250, height: 280 },
    { id: 'btnChancelaria', yaw: -125, pitch: 15, width: 500, height: 300 },
    { id: 'cityGuildHotspot', yaw: -118, pitch: 60, width: 140, height: 150 },
];
...
// ao vivo de #guild_name_zion/#guild_flag_zion (já preenchidos por
// fetchAndDisplayCityOwner, em zion.html). Se não houver guilda regente
// no momento (dataset.cityHidden === '1'), o clique não faz nada.
// ════════════════════════════════════════════════════════════════════════════

const GUILD_ID_SUFFIX = 'zion';
...
const PM_SCENE_IMAGE_URL = 'https://aden-rpg.pages.dev/assets/mdp_zion.png'; // mesma imagem do antigo background do modal da loja
const PM_NPC_IMAGE_URL   = 'https://aden-rpg.pages.dev/assets/mdp_seller_zion.webp';
const PM_TUTORIAL_KEY    = 'mdpTutorialSeen_zion'; // localStorage — tutorial não repete depois da 1ª vez
